...
<form role="form" name="place_info" method="post" action="action/action-add-place.php">
    ...
    <div class="form-group">
    <b> Place Photo(link):<br></b>
    <input name="place_photo" type="text" class="form-control" >
    </div>
